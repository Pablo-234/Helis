...
from helis.child_agent_domain import (
    ChildAgentArtifact,
    ChildAgentRunResult,
    ChildAgentRunStatus,
)
...
class ChildAgentRuntime:
    ...
    def _safe_target(self, relative: Path) -> Path:
        ...
        try:
            ...
            raise ChildAgentArtifactTampered(
                "child-agent run path escapes venture workspace"
            ) from exc
        return target
